...
Devise.setup do |config|
  ...
  # config.secret_key = 'a6733b12bde2b20d92680791f53162cb80f968a751d60da2c454ac45f2f8ae0671b1c7798f33eb5489607583581c0ef56dc5ba19e363ecfc253ee89c527c5387'
  ...
  # config.pepper = 'e378ee04b0a99dbe95da0ae9d55058a8670319b7c4bedf9b59cbcc3febc4bdfc6719fa86e9949328c4fd4b7cd2c1f66a0edb45a80274ad7099d3090d8121f450'
  ...
  config.saml_configure do |settings|
    ...
    settings.assertion_consumer_service_url     = ENV.fetch('ASSERTION_CONSUMER_SERVICE_URL', '')
    settings.assertion_consumer_service_binding = ENV.fetch('ASSERTION_CONSUMER_SERVICE_BINDING', '')
    settings.name_identifier_format             = ENV.fetch('NAME_IDENTIFIER_FORMAT', '')
    settings.issuer                             = ENV.fetch('ISSUER', '')
    settings.idp_slo_service_url                = ENV.fetch('IDP_SLO_SERVICE_URL', '')
    settings.idp_sso_service_url                = ENV.fetch('IDP_SSO_SERVICE_URL', '')
    settings.idp_cert_fingerprint               = ENV.fetch('IDP_CERT_FINGERPRINT', '')
    settings.idp_cert_fingerprint_algorithm     = ENV.fetch('IDP_CERT_FINGERPRINT_ALGORITHM', '')
  end
end
